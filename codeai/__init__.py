...
def generate_translator(model_id='1qZmBK0wHO3OZblH8nabuWrrPXU6JInDc', model_file='./model.zip', beams=5):
    if not os.path.exists(MODEL_DIR):
        GoogleDriveDownloader.download_file_from_google_drive(file_id=model_id, dest_path=model_file, unzip=True)
    nmt = NMT(MODEL_DIR)
